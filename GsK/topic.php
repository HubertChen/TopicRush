...
foreach($result as $row) {
  $productlink = "0";
  if ($row['productid'] != 0) {
    $productlink = '<a href="http://localhost/product.php?id=' . $row['productid'] . '">' . $row['productid'] . '</a>';
  }
  echo $row['topicid'] . "," . $row['communityid'] . "," . $row['ownerid'] . "," . $row['followid'] . "," . $productlink . "," . $row['name'] . "," . $row['created'] . "<br>";

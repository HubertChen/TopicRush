...
?>
<script>
	$("#loginBody").prepend("<div class='alert alert-success' role='alert'>Successfully logged out.</div>");
</script>
<?php
}
...
if(isset($_POST['submit'])){
	...
	if($database->verify_user($username, $password)){
		...
		<script>
        		$("#loginBody").prepend("<div class='alert alert-danger' role='alert'>Incorrect Login</div>");
		</script>
	<?php
	}
}

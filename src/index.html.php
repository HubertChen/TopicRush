        	...
        	<div class="navbar-collapse collapse" align="center">  
          		<form class="navbar-form navbar-form-length"  role="search" action="search.php" method="post">
            		<div class="form-group">
              			<input type="text" class="form-control" name="search" placeholder="Search for communities, topics, and products" size="70" maxlength="70" required>
            		</div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="topic.php" role="button">Follow &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        ...
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="product.php" role="button">Review &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->

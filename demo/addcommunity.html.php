        	...
        	<div class="col-md-6">
				...
				<form action="addcommunity.php" method="post" enctype="multipart/form-data" role="form">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="communityname" id="communityname" placeholder="Enter name(30 character limit)" value="<?php echo $communityname ?>" required>
					</div>
					<div class="form-group">

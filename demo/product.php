...
<?php     
  ...
  //navbar: user is logged in           
	...
	$maxdisplay = 0;
  	...
  	while($row = mysqli_fetch_array($result)) { $totalproducts = $row["count(productid)"]; }
  	...
  	if ($totalproducts > 0) {
    	...
    	$result = mysqli_query($con,$sql);
    	while($row = mysqli_fetch_array($result)) { array_push($productarray,$row["productid"]); }
      		...
      		while($row = mysqli_fetch_array($result)) {
				...
				echo '<div class="col-md-3">';
					echo '<table align="center">';
						echo '<tr>';
							echo '<td align="center"><a href="viewproduct.php?id=' . $row["productid"] . '"><img class="img-circle" src="' . $imagepath . '" height="150" width="150" alt="' . $row["name"] . '"></a></td>';
						echo '</tr>';
						echo '<tr>';

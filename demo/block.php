	  ...
	  echo '<div class="row ">';
  		echo '<div class="col-md-3">';
  			echo '<table align="center" >';
  				echo '<tr>';
  					echo '<td align="center"><a href="viewcommunity.php?id=' . $communityid . '"><img class="img-circle"  img src="' . $communitylogo . '" height="150" width="150" alt="Generic placeholder image"></a></td>';
  				echo '</tr>';
  			echo '</table>';
  		echo '</div>';
		...
		echo '<div class="alert alert-success alert-dismissable" align="center">
     					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
						You have blocked ' . $blockname . ' for the following reason:<br/><strong>' . $blockreason . '
						</strong></div>';		
		echo '</div>';
	echo '</div>';
      ...
      $sql = "insert into block(memberid,communityid,reason) values('" . $memberid . "','" . $communityid . "','" . $blockreason . "')";

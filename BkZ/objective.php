          ...
          <form class="navbar-form navbar-form-length"  role="search" >
            <div class="form-group">
              <input type="text" class="form-control" placeholder="Seach for communities, topics, and products" size="70" maxlength="70">
            	...
            	<a href="signup.html"><button type="button" class="btn btn-primary navbar-btn-right" >Sign Up</button></a>
          </form>  
        </div>
      </div>
    </div>
    	...
    	<div class="col-md-12">	
      		<div class="container">
        		...
        		<div class="row featurette">
        			...
        			<div class="col-md-5">
                 		<img class="featurette-image img-circle img-responsive" data-src="holder.js/500x500/auto" alt="500x500">
        			</div>
      			</div>
      		</div>
		</div>
    ...
    ================================================== -->
      ...
      <div class="container"> 
      	...
      	<footer>
        	...
        	<p style="color:#c1c1c1">&copy; 2014 Circle, Inc. &middot; <a href="#" style="color:white">Privacy</a> &middot; <a href="#" style="color:white">Terms</a> &middot; <a href="#" style="color:white">About</a></p>
      	</footer>
      </div><!-- /.container -->

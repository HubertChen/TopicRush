...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $hashed_password = '$1$014.Hv5.$i.A1vfoUH1WyLRTQbpmS30';
    if (crypt($postpassword, $hashed_password) == $hashed_password) {
      echo "Password verified!";
    }
  } // end if post message received

  echo '<form class="form-signin" role="form" action="testhash.php" method="post">';
